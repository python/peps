...
For reference, here are all of the possible header fields::
...
PEP 1 [1]_. Those sections are provided here for convenience (sans the
"Copyright" section and the metadata footer).
::
