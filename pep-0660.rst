...
Scripts in the .data directory are therefore not supported by this PEP either,
and package authors are encouraged to migrate to ``console_scripts`` entry
points, or make their scripts tiny wrapper around library functionality.
