...
- Encourage users to specify core metadata statically for speed,
  ease of specifying, deterministic consuming by build back-ends,
...
back-end has been used to produce an artifact then the metadata
...
eyes of this PEP, an sdist is considered a build artifact, thus people
should not read the metadata specified in this PEP as the canonical
metadata in an sdist.
