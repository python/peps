...
The message must be a string literal or be statically resolvable to a single string
(e.g., a :data:`typing.Final` variable of type ``str``).
...
CPython's deprecation policy (:pep:`387`) will require that new deprecations
