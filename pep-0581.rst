...
[#backup-github]_. We're using GitHub Migrations API [#gh-migrations-api]_
...
to GitHub [#github-cpython-1]_ and [#github-cpython-2]_, it was brought up that
...
docs@python.org [#docs-ml]_ mailing list, to allow people to submit their issues
there.
...
.. [#nosy-list] Roundup issue 2550742 Do not send email by default when adding
