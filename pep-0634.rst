...
By default, sub-patterns may only match by keyword for
...
on the subject, it is instead matches the subject itself.  This
...
* The interpreter will check that two sub-patterns are not targeting the same
