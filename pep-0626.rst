...
Statements are made up of keywrds and expressions. Not all keywords have a direct runtime effect, so not all keywords are considered to be executable code. 
