...
The three API incompatibilities that most users of current ``toml`` would run into
...
are other minor or less widely used API differences; if interested, refer to this
