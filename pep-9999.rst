...
code that are executed. The ``f_lineo`` attribute of frame objects should always give the expected line number.
...
This guarantee also benefits implementers of Python, as the current behaviour is not obvious and has some odd corner cases.

Rationale
=========

Users and tools should be able to expect that line events are generated for all lines of code and only for lines of code.
