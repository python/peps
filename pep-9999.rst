...
* Having an additional bdist format is confusing to end users, who may
...
of the deprecation period, maintainers of projects that already have egg
distributions will receive a one-time email informing them of the upcoming
restrictions on egg distribution uploads.
...
during this period will result in an email to all maintainers of the project,
which will inform them of the upcoming restrictions on egg distribution
uploads.
