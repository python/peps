...
- numpy used to have an undocumented behavior where it would access a ``__buffer__`` attribute
  ...
  in 2019 for numpy 1.17. The behavior would have last worked in numpy 1.16, which supported
  Python 3.7. Python 3.7 will have reached its end of life by the time this PEP is expected to
  be implemented.
