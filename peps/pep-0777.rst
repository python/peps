...
updated resolvers, based on current data about PyPI installer usage (See
Appendix A for details). To allow for experimentation and faster adoption of
2.0 wheels, this PEP proposes a one time change to the file extension of the
