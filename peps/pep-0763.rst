...
* A **project** is deletable if all of its releases are deletable.
...
are more likely to have a "tail" of adopted releases. Their downstream users
are not necessarily equipped to address the sudden deletion
of a release, file, or the whole project.
