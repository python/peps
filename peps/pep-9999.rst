...
associated with a formal PEP process or new metadata version. Consequently,
this PEP proposes that the list above become a "living" list within the
living core metadata standard, which PyPA members may amend via ordinary
