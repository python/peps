...
referencing an auxiliary variable, reducing clutter.  Additionally, using a
single ``LIST_EXTEND`` instead of repeated ``LIST_APPEND`` means that the
updated version tends to be more efficient as well.
