...
* Organization B cannot share the grant with other organizations.
* Organization B cannot produce a child grant.
...
3. Would *not* reserving the namespace cause ambiguity, confusion, or other
