...
At the time of writing, free-threading Python is Phase I: experimental phase.
In this there is an acute need for the proposed environment markers to help
with the transition to free-threading Python as package authors gradually add
support.
...
from GIL-enabled as default to free-threading as default.
