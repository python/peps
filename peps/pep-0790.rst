...
`Searching GitHub <https://github.com/search?q=%2Ffor+%5Cw%2B+in+%5Beg%5D%5Cw*%5C.exceptions%3A%2F+language%3APython&type=code>`__
found four implementations of ``flat_exceptions()`` by various names in the
first sixty hits, of which none handle tracebacks.[#numbers]_  The same search
found thirteen cases where ``.flat_exceptions()`` could be used.  We therefore
believe that providing an upstream method with proper traceback preservation
...
lines <https://github.com/python-trio/trio/issues/2001#issuecomment-931928509>`__ -
a volume which makes understanding errors far more difficult than it should be.

A new ``BaseException.preserve_context()`` method would be a discoverable,
...
.. code-block:: python
    ...
    class preserve_context:
        ...
        def __exit__(self, exc_type, exc_value, traceback):
            ...
            del self.__context, self.__suppress_context  # break gc cycle
