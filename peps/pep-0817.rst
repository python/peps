...
As of the time of writing, CuPy_ has already published a total of 52
``cupy-cuda*`` packages with different names, most of them no longer
updated. This clearly highlights the magnitude of the problem.
End users need to
