...
There are some constants which may be interesting to implement as constants:
either deny modifying them, or at least disallow removing them.  Examples:
:py:obj:`os.sep`, :py:obj:`os.environ`, :py:obj:`math.pi` or
:py:obj:`http.client.HTTP_PORT`.
