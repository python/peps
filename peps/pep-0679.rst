...
Created: 07-Jan-2022
Python-Version: 3.15
Message-history: `Jan 2022 <https://discuss.python.org/t/pep-679-allow-parentheses-in-assert-statements/13003>`_,
                 `Dec 2021 <https://github.com/python/cpython/issues/90325>`_
...
Making `assert` look more similar to a function call encourages a wrong mentality.
