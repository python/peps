...
We don't have solid numbers here, but believe that many projects are affected
in the wild.  After one moderate and one critical bug attributed to suspending
a cancel scope at work, Zac developed tooling to enforce a company-wide ban
on async generators.  When describing this PEP at PyCon, three attendees
recognized the symptoms and concluded that they had likely been affected.
