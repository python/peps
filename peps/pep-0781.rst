...
and their current import names will be deprecated. This is both to avoid user
confusion about where to find compression modules and to avoid the same issue
occuring when adding other new compression modules in the future.
