...
If you're thinking about building a grammar with template strings, we hope you'll
find it useful.
...
simple syntax, but they are both powerful tools that add new expessiveness
...
During the authoring of this PEP, we consiered removing the ``conv`` attribute 
