...
.. code-block:: python
    ...
    class Template:
        ...
        """
        A tuple of the N interpolations in the template. This can
        be an empty tuple.
        """
...
semantics from the ``object`` class. No attempt is made to provide a custom
...
own custom equality semantics as needed.
...
.. code-block:: python
    ...
    assert t.strings[0] == r'Did you say "'
    assert t.strings[1] == r'"?\n'
