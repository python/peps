...
Example: f-strings with t-strings
=================================

It is easy to "implement" f-strings using t-strings. This code processes
a template string in much the same way as an f-string:
    ...
    def f(template: Template) -> str:
        ...
        for arg in template.args:
            match arg:
                case str() as s:
                    parts.append(s)
                case Interpolation(value, conv, format_spec):
