...
.. code-block:: python
    ...
    attributes = {"class": "exciting", "id": "fresh"}
    template = t"<div {attributes} />"
    assert html(template) == '<div class="exciting" id="fresh" />'

TODO::: TODO ::: TODO ::: 
TODO::: I haven't touched anything below here yet. Just getting started! -Dave
