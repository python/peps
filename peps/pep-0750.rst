...
Author: Jim Baker <jim.baker@python.org>, Guido van Rossum <guido@python.org>, Paul Everitt <pauleveritt@me.com>, Koudai Aono <koxudaxi@gmail.com>, Dave Peck <davepeck@davepeck.org>, Lysandros Nikolaou <lisandrosnik@gmail.com>
        ...
        for arg in template.args:
            match arg:
                ...
                case Interpolation(value, _, conv, format_spec):
                    ...
                    value = format(value, format_spec)  # mypy in strict mode will probably complain here?
                    parts.append(value)
        return "".join(parts)
...
.. code-block:: python
    ...
    class TemplateMessage:
        ...
        def values(self) -> Mapping[str, object]:
            return {
                arg.expr: arg.value
                for arg in self.template.args  # Shouldn't we be using self.template.args[1::2] here?
                if isinstance(arg, Interpolation)
            }
...
.. code-block:: python
    ...
    class ValuesFormatter(Formatter):
        def values(self, template: Template) -> Mapping[str, Any]:
            return {
                arg.expr: arg.value
                for arg in template.args  # Same comment as above
                if isinstance(arg, Interpolation)
            }
