...
Author: Jim Baker <jim.baker@python.org>, Guido van Rossum <guido@python.org>, Paul Everitt <pauleveritt@me.com>, Dave Peck <davepeck@gmail.com>
...
message *and* the values, combining them both into a final string. (See the
...
the template string's ``Interpolation.expr`` and ``Interpolation.value`` 
