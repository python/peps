...
group that parses the expression statement on the following logical line. An
action helper returns the string value if the result is a string constant.
...
must be in the same suite as the :py:keyword:`type` statement.
...
.. _Compiler: https://github.com/johnslavik/cpython/commit/a793afb20c88d4124814f4b90e877fb7412c5d4e
