...
The Python Steering Council is expected to delegate decision making to the
Packaging Council for PEPs related to the Python packaging.  The bodies would
work together on issues that intersect the packaging domain and language
...
members are explicitly exempt from this restriction, but _not_ PSF employees,
