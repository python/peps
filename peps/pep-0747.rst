...
``TypeForm`` can also be used with :ref:`TypeIs <typing:typeis>` to define
custom type narrowing behaviors::
...
providing useful functions that accept type form objects as input.
...
.. [#type_t]
   :ref:`Type[T] spells a class object <typing:type>`

.. [#TypeIs]
   :ref:`TypeIs[T] is similar to bool <typing:typeis>`
