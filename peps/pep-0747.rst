...
.. [#type_t]
   `Type[T] <https://typing.readthedocs.io/en/latest/spec/special-types.html#type>`__ spells a class object

.. [#TypeIs]
   `TypeIs[T] <https://typing.readthedocs.io/en/latest/spec/narrowing.html#typeis>` is similar to bool
