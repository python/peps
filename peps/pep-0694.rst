...
This mechanism **MUST** use the same authentication scheme as the
:ref:`Root <root-endpoint>`,
:ref:`Publishing Session <publishing-session>`,
and :ref:`File Upload Session <file-upload-session>` endpoints.
