...
::
   ...
   TypeVar("Ok", default=T1, bound=int)        # Valid
   TypeVar("AlsoOk", default=T1, bound=float)  # Valid
   TypeVar("Invalid", default=T1, bound=str)   # Invalid: str is not a subtype of float
