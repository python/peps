...
momentum, seeing adoption by PyPI, NPM, Homebrew, GitHub, among other
ecosystems.
...
This situation slows down the adoption of Sigstore downstream vertically
between ecosystems and horizontally across ecosystems by not creating a "need"
to automate and integrate the signature method into verifier tooling.
