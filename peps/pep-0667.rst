...
.. Syntax blocks are a mix of Python, C, and Python interactive prompts, so let Pygments guess
.. highlight:: guess
...
As noted in the Rationale section, the above behavioural description may be
