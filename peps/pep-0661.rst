...
Sentinel objects may be used in :term:`type expressions <typing:type expression>`,
...
represent a :term:`fully static type <typing:fully static type>` that has a single member, the sentinel object itself.
