...
.. c:function:: PyInterpreterRef PyInterpreterRef_Main(PyInterpreterRef *ref)
...
.. code-block:: c
    ...
    my_critical_operation(PyObject *self, PyObject *unused)
    {
        ...
        PyInterpreterRef ref = PyInterpreterRef_Get(&ref);
        if (ref == 0) {
            /* Python interpreter has shut down */
            return NULL;
        }
...
.. code-block:: c
    ...
    call_python(void)
    {
        PyInterpreterRef ref = PyInterpreterRef_Main();
        if (ref == 0) {
