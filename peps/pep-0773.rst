...
management of these installs to resume. Running ``--purge`` before uninstalling
...
and so we do not intend to specify the details here (beyond normal compatibility
requirements apply).
