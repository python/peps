...
*nesting and combining patterns*.  The nesting allows for expressing deep
...
favour of the simpler and consistent rule based on equality.  Moreover, any
...
in that a string is a sequence of strings).  The typical behaviour and use
