...
The converted values include:

* The value specified during object construction
* The value of ``default``, when used
* The return value of ``default_factory``, when used
* The value used for attribute assignment on the object
...
* Forgetting to convert values in the bodies of user-defined ``__init__`` and
  ``__setattr__``.
