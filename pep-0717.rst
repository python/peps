...
practice PyPI has supported HTTP's `Basic Authentication <https://datatracker.ietf.org/doc/html/rfc7617>`__
for its entire life, which means that every client implements basic auth and
typically nothing else. This makes basic auth our "Lingua Franca" of
authentication on a repository.
