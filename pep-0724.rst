...
Intersection of types is being discussed `here`__ and will likely be specified
in a future PEP. Negation of types may end up being implemented by each type
checker as the negation of gradual types is `not well defined`__.

__ https://github.com/CarliJoy/intersection_examples/blob/main/specification.rst
__ https://github.com/python/typing/issues/801#issuecomment-1679883519
