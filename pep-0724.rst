...
This means existing code would continue to work with the ``False`` narrowing.
Meaning this change could be considered backwards compatible because it's not
actually changing any runtime behavior.
