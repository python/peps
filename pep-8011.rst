...
authority to pronounce on PEPs (except for the governance PEP), and to
decide whether a particular decision requires a PEP. The trio's
authority does not include changing the governance itself, or any
other non-PEP-related disputes that may arise; these should be handled
through the process described in PEP 8001.
