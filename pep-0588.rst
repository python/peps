...
The "Python Triage" team has been created. Description and expectation of the
triage role `has been added to Devguide <https://devguide.python.org/triaging/#python-triage-team>`_.
