...
.. csv-table:: Table 1: Proposed modules deprecations
   ...
   :widths: 2, 1, 1, 1, 1, 2
    ...
    crypt,3.8,3.10,1994,**yes (inactive)**,"`legacycrypt <https://pypi.org/project/legacycrypt/>`_, `bcrypt <https://pypi.org/project/bcrypt/>`_, `argon2cffi <https://pypi.org/project/argon2-cffi/>`_, `hashlib <https://docs.python.org/3/library/hashlib.html>`_, `passlib <https://pypi.org/project/passlib/>`_"
    ...
    imghdr,3.8,3.10,1992,no,"`filetype <https://pypi.org/project/filetype/>`_, `puremagic <https://pypi.org/project/puremagic/>`_, `python-magic <https://pypi.org/project/python-magic/>`_"
    imp,**3.4**,3.10,1990/1995,no,`importlib <https://docs.python.org/3/library/importlib.html>`_
    ...
    parser,**2.5**,**3.9**,1993,**yes**,"`ast <https://docs.python.org/3/library/ast.html>`_, `astroid <https://pypi.org/project/astroid/>`_, lib2to3.pgen2"
    pipes,3.8,3.10,1992,no,"`subprocess <https://docs.python.org/3/library/subprocess.html>`_"
    smtpd,"**3.4.7**, **3.5.4**",3.10,2001,**yes**,"`aiosmtpd <https://pypi.org/project/aiosmtpd/>`_"
    sndhdr,3.8,3.10,1994,no,"`filetype <https://pypi.org/project/filetype/>`_, `puremagic <https://pypi.org/project/puremagic/>`_, `python-magic <https://pypi.org/project/python-magic/>`_"
    spwd,3.8,3.10,2005,no,"`python-pam <https://pypi.org/project/python-pam/>`_, `simplepam <https://pypi.org/project/simplepam/>`_"
    sunau,3.8 (3.0\*),3.10,1993,no,\-
    telnetlib,3.8 (3.0\*),3.10,1997,no,"`telnetlib3 <https://pypi.org/project/telnetlib3/>`_, `Exscript <https://pypi.org/project/Exscript/>`_"
    uu,3.8,3.10,1994,no,\-
