...
.. csv-table:: Table 1: Proposed modules deprecations
   ...
   :widths: 1, 1, 1, 1, 2
    ...
    email.message.Message,3.3,3.10,no,email.message.EmailMessage
    email.mime,3.3,3.10,no,email.contentmanager
    email.policy.Compat32,3.3,3.10,email.policy.EmailPolicy
