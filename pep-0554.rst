...
+---------------------------------------------------+---------------------------------------------------+
| ``.run(src_str, /, *, channels=None) -> Status``  | | Run the given source code in the interpreter    |
|                                                   | | (in its own thread).
+---------------------------------------------------+---------------------------------------------------+
...
The module also provides the following classes::
   ...
   class Interpreter(id):
      ...
      run(source_str, /, *, channels=None) -> Status:

         Run the provided Python source code in the interpreter and
         return a Status object that tracks when it finishes.  If
