...
As with star-unpacking in other contexts, the star operator calls ``__iter__`` on the callee,
and adds the contents of the resulting iterator to the list of index arguments.
This enables ``TypeVarTuple`` to be implemented as roughly:
