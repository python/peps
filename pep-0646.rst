...
::
    ...
    C[*Ts]       # __class_getitem__ receives x=(_UnpackedTypeVarTuple, )
    # This is consistent with:
    C[*Ts, int]  # __class_getitem__ receives x=(_UnpackedTypeVarTuple, int)
...
would therefore be implemented in e.g. ``typing.py`` rather than at the syntax level.
...
This accomplishes the desired outcome:

::

    >>> def foo(*args: *b): pass
    >>> foo.__annotations__
    {'args': (_UnpackedTypeVarTuple,)}
