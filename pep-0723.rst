...
are that already work with TOML.
...
+---------------------+------------------------------------------------------+------------------------------------------------------+
| Fields              | Description                                          | Tool behavior                                        |
+=====================+======================================================+======================================================+
| ``dependencies``    | A list of strings that specifies the runtime         | Tools will error if the specified dependencies       |
|                     | dependencies of the script. Each entry must be a     | cannot be provided.                                  |
|                     | valid :pep:`508` dependency.                         |                                                      |
|                     |                                                      |                                                      |
|                     |                                                      |                                                      |
+---------------------+------------------------------------------------------+------------------------------------------------------+
| ``requires-python`` | A string that specifies the Python version(s) with   | Tools might error if no version of Python that       |
|                     | which the script is compatible. The value of this    | satisfies the constraint can be executed.            |
|                     | field must be a valid                                |                                                      |
|                     | :pep:`version specifier <440#version-specifiers>`.   |                                                      |
|                     |                                                      |                                                      |
+---------------------+------------------------------------------------------+------------------------------------------------------+
| ``version``         | A string that specifies the version of the script.   | Tools may use this however they wish, if defined.    |
|                     | The value of this field must be a valid :pep:`440`   |                                                      |
|                     | version.                                             |                                                      |
+---------------------+------------------------------------------------------+------------------------------------------------------+
