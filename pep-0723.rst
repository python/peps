...
wheels. Although the outcome of that will likely be that the project name and
version become optional in certain circumstances, this PEP considers the
discussion only tangentially related.
