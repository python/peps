...
We considered extending the use of entry_points to allow specifying scripts
...
entry_points is to make it easy for libraries to install scripts at startup,
