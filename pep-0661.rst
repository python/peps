...
* For a long time, the author of this PEP strove to have type signatures for
  ...
  The author has come to the conclusion that such sentinels are not important
  enough to add complexity to type checkers, and especially not important
  enough for users of Python to need to learn something new and special.
