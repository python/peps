...
* For a long time, the author of this PEP strove to have type signatures for
  ...
  special-casing and/or added complexity.  Therefore, this PEP no longer
  proposes such signatures, since it seems better to forego them rather than
  add complexity to type checkers and add one more special case that users of
  Python to need to know about.
