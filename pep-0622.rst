...
Many other languages supporting pattern-matching use it as a base for multiple
...
of the first draft. Another question asked is why this particular form (joining
binding and conditional selection) and not others were chosen.

Introducing more uses of patterns would be too bold and premature for the
...
is sufficiently general to be useful while being self-contained and not
having a massive impact in the syntax and semantics of the language as a whole.

After some experience with this feature, the community may have a better
knowledge of what other pattern matching constructs could be valuable in Python.
