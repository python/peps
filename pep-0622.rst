...
We recongize that some of the use cases for the `match` statement overlap
...
behaviors based on the testing the runtime type of a match subject might
even seem heretical to strict OOP purists.

However, Python has always been a language that embraces a variety
programming styles and paradigms. Classic Python design idioms such as
"duck"-typing go beyond the traditional OOP programing model.
