...
* ``transform_descriptor_types`` indicates whether, for fields whose
  ...
  parameter type. If False, the descriptor type will be used. If not
  specified, ``transform_descriptor_types`` will default to False (the
  default behavior of dataclass).
