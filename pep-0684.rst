...
(and reentrant) allocator like mimalloc.

.. XXX address GIL requirement for "mem"/"obj" allocators
   https://docs.python.org/3/c-api/memory.html#allocator-domains
   https://peps.python.org/pep-0445/#gil-free-pymem-malloc

.. XXX How does per-interpreter GIL affect tracemalloc?

.. XXX How does per-interpreter GIL affect faulthandler?
...
.. XXX Do we need an extra indicator (e.g. moduledef slot) for
