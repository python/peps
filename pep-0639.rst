...
As `specified by this PEP <License files in project formats_>`_, its value
...
or MAY be treated as a unique abstract key to access the license file contents
by another means as specified by the format.
