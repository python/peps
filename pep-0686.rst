...
This PEP proposes to enable :pep:`UTF-8 mode <540>` by default.
...
encoding is a platform dependent.
...
* Disable UTF-8 mode.
* Use ``EncodingWarning`` to find where the default encoding used and use
...
Java also rejected this idea in the `JEP 400`_.
