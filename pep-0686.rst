...
* Most text editors, including Visual Studio Code and Windows Notepad use UTF-8 by
  default.
...
Changing the default encoding to UTF-8 makes it easier for Python to interoperate
with them.
